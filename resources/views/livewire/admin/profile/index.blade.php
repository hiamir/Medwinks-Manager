<div>
{{--    <x-admin-header viewname="Profile"></x-admin-header>--}}
    <livewire:components.admin-header :viewname='$viewname'/>
    {{--<livewire:components.adminheader :viewname='$viewname'/>--}}
    <section class="section">
        <div class="card">
            <div class="card m-4 bg-light-secondary shadow-sm" style="max-width:1024px; ">
                                ...
                                <div class="col-md-12 profile-center">
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-right">
                                            ...
                                            {{--                                        <a href="#" class="btn btn-outline-primary rounded-pill text-sm">Edit Profile</a>--}}
