...
document.getElementById('text').addEventListener('click', (e) => {
     ...
     Swal.fire({
        title: 'Enter your IP addresses',
        input: 'text',
        inputLabel: 'Your IP addresses',
...
document.getElementById('email').addEventListener('click', async (e) => {
    ...
    const { value: email } = await Swal.fire({
        title: 'Input email addresses',
        input: 'email',
        inputLabel: 'Your email addresses',
        inputPlaceholder: 'Enter your email addresses'
      })
